...
pub mod coordinator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn example(
        ...
        ) -> std::result::Result<tonic::Response<super::ExampleReply>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("coordinator.Coordinator", "Example"));
                ...
                "/coordinator.Coordinator/Example" => {
                    ...
                    for ExampleSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Coordinator>::example(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
